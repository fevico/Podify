...
export const getLastesUploads: RequestHandler = async(req:CreateAudioRequest, res) =>{
    const list = await Audio.find().sort("-createdAt").limit(10).populate<PopulatedFavList>("owner");
